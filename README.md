...
| | |
| :--- | :--- |
| **[CoworkOS](https://github.com/theAnirudhKumar/CoworkOS)** | The workstation-based memory and routing system that runs everything else on this page, stripped of anything personal and packaged as an installable template: a routing protocol, persistent memory, one rule for where anything belongs. Built for Claude Cowork, documented to also work with ChatGPT Work Mode, Kimi Work, OpenClaw and Hermes Agent. It is the one thing here that is a template rather than a skill, per the rule below: it needs a folder your AI tool can read and write to, so it cannot run with no prerequisites the way the others do. |
| **[work-design](https://github.com/theAnirudhKumar/work-design)** | Design the work before you do it. Vetting a tool before you sign up, deciding what to hand to an agent and what to keep, carrying context from one session into the next, catching an expensive request before it runs. Nine skills across three categories. |
...
| **[customer-success-skills](https://github.com/CSPulse/customer-success-skills)** | Thirty-two AI skills for the work customer success actually does. Reading an account honestly, running the set-piece moments, handling the conversations, writing the things customers read. The resource hub for CS Pulse. |
